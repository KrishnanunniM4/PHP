<?php
    ...
    $pdo = new PDO('mysql:host=localhost;port=3306;dbname=learners_krishnanunni', 'learners_krishnanunni', 'krishnanunni');
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        if (empty($errors))
        {
            ...
            $statement = $pdo->prepare("INSERT INTO events (event_id, event_name, description, event_location, thumbnail_img, event_start, event_end, reg_start, reg_end, reg_fees)
                                        VALUES (:event_id, :event_name, :description, :event_location, :thumbnail_img, :event_start, :event_end, :reg_start, :reg_end, :reg_fees)");
